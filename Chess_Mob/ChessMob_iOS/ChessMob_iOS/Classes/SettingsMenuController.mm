...
ChessMob::PieceType pieceTypes[] = {ChessMob::QueenPiece, ChessMob::RookPiece, ChessMob::BishopPiece, ChessMob::KnightPiece, ChessMob::PawnPiece};
int p1PieceType = 0;
int p2PieceType = 0;
...
- (IBAction) OnP1PieceButtonClick: (id) sender{
	p1PieceType = (p1PieceType + 1) % 5; // Since there are 5 types of pieces
...
- (IBAction) OnP2PieceButtonClick: (id) sender{
	p2PieceType = (p2PieceType + 1) % 5; // Since there are 5 types of pieces
