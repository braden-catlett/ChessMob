...
public class GameActivity extends Activity 
{
	...
	private void ShowMenu(final boolean HideReturnToGame) 
	{
		...
		returntomenu.setOnClickListener(new OnClickListener() 
		{
			...
			public void onClick(View v)
			{
				...
				intent.setClass(getApplicationContext(), com.chessmob.chessmobandroid.MainActivity.class);
		...
		{			
			...
			{
				Intent intent = new Intent();
				intent.setClass(getApplicationContext(), com.chessmob.chessmobandroid.GameSettings.class);
				intent.putExtra("ClearSavedData", HideReturnToGame);
				startActivity(intent);
			}
		});
	...
	{
		final int[] piecesWhite = { R.drawable.queen_white, R.drawable.rook_white, R.drawable.bishop_white, R.drawable.knight_white};
		final int[] piecesBlack = { R.drawable.queen_black, R.drawable.rook_black, R.drawable.bishop_black, R.drawable.knight_black};
		...
		if(isWhiteTurn)
			icon.setImageResource(R.drawable.queen_white);
		else
			icon.setImageResource(R.drawable.queen_black);
