...
- (IBAction)OnUpgradeButtonClick:(id)sender{
//    NSString *iTunesLink = @"itms-apps://itunes.apple.com/app/id739643192";
    NSString *iTunesLink = @"https://itunes.apple.com/us/app/chess-mob/id739643192?ls=1&mt=8";
